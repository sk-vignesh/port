...
export const ASSET_CLASS_ICONS: Record<string, string> = {
  EQUITY:       '💹',   // Trending chart — stocks, ETFs
  MUTUAL_FUND:  '📊',   // Bar chart — mutual funds, index funds
...
export const ASSET_CLASS_LIST = [
  { id: 'EQUITY',       icon: ASSET_CLASS_ICONS.EQUITY,       label: ASSET_CLASS_LABELS.EQUITY,       desc: 'NSE / BSE listed shares, ETFs' },
  { id: 'MUTUAL_FUND',  icon: ASSET_CLASS_ICONS.MUTUAL_FUND,  label: ASSET_CLASS_LABELS.MUTUAL_FUND,  desc: 'AMFI-registered schemes: equity, debt, hybrid funds' },
